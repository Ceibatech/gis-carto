...
ALTER TABLE ceiba_inventory_forms
  ...
  ADD COLUMN IF NOT EXISTS box_reference VARCHAR(190) NULL AFTER carton_id,
  ADD COLUMN IF NOT EXISTS barcode VARCHAR(190) NULL AFTER box_reference,
  ...
  ADD KEY IF NOT EXISTS ceiba_inventory_box_reference_idx (box_reference),
